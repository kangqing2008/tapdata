 ...
 * @author Dexter
 */
public class TaskSampleReporterV2 implements BulkReporter {
    private final Logger logger = LogManager.getLogger(TaskSampleReporterV2.class);

    private final ClientMongoOperator operator;

    public TaskSampleReporterV2(ClientMongoOperator operator) {
